"""In this simple example we attempt to determine how many
packets-per-second must be sent over a SpiNNaker link before back
pressure applied by the network prevents packets being
injected."""
